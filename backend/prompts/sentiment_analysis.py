...
- **同主题合并**: 同一事件的连续报道（如每日回购、逐日行情）应当合并——details 中保留最新/最具代表性的一条，其余在 key_topics 的 description 中概括（如"6月15-17日连续回购，累计约15亿港元"）。**但若输入新闻总数 ≤ 3 条，即使主题相同也全部保留在 details 中**，以确保信息完整
- **details 数量要求**: 输入 ≥3 条不同主题 → details 至少 2-3 条；输入 1-2 条 → **全部保留**，不得省略
